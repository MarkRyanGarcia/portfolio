...
export default function Intro() {
    return (
        <div className="flex flex-col w-full gap-6 p-4 md:justify-center md:flex-row md:items-center bg-base-2 border-secondary border rounded-lg text-primary">
            <AboutImage />
    ...
    {/* <div className="flex flex-col gap-5 w-full md:items-center bg-base-2 border-secondary border rounded-lg text-primary">
            <div
